...
function Hero() {
  ...
  return (
    <div className="pt-20">
      <section className="relative bg-gradient-to-br from-navy-950 via-navy-900 to-navy-800 overflow-hidden" style={{background: 'linear-gradient(135deg, #050E1E 0%, #0B1C31 38%, #0C243D 100%)'}}>
        {/* Gold geometric pattern overlay */}
        <div className="absolute inset-0 opacity-10" style={{backgroundImage: `url("data:image/svg+xml,%3Csvg width='60' height='60' xmlns='http://www.w3.org/2000/svg'%3E%3Cdefs%3E%3Cpattern id='grid' width='60' height='60' patternUnits='userSpaceOnUse'%3E%3Cpath d='M 10 0 L 0 0 0 10' fill='none' stroke='%23D4AF5F' stroke-width='1'/%3E%3C/pattern%3E%3C/defs%3E%3Crect width='100%25' height='100%25' fill='url(%23grid)'/%3E%3C/svg%3E")`}}></div>

        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20 lg:py-32">
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div className="space-y-8">
              <div className="inline-block">
                <span className="border border-yellow-500 text-yellow-400 text-sm font-semibold px-4 py-2 rounded-full" style={{background: 'rgba(212,175,95,0.12)', borderColor: 'rgba(212,175,95,0.5)', color: '#E7C98A'}}>
              ...
              <div className="flex flex-col sm:flex-row gap-4">
                <a
                  ...
                  style={{background: 'linear-gradient(135deg, #D4AF5F, #E7C98A)'}}
                  onMouseEnter={e => (e.currentTarget.style.background = 'linear-gradient(135deg, #C29A3A, #D4AF5F)')}
                  onMouseLeave={e => (e.currentTarget.style.background = 'linear-gradient(135deg, #D4AF5F, #E7C98A)')}
                >
                  <span style={{color: '#050E1E', fontWeight: 700}}>Book a Cleaning</span>
                  <ArrowRight className="w-5 h-5 group-hover:translate-x-1 transition-transform" style={{color: '#050E1E'}} />
                </a>
              </div>
              ...
              <div className="grid sm:grid-cols-3 gap-4 pt-8">
                {features.map((feature, index) => (
                  <div key={index} className="flex items-start space-x-2">
                    <feature.icon className="w-5 h-5 flex-shrink-0 mt-1" style={{color: '#D4AF5F'}} />
            ...
            <div className="relative">
              <div className="absolute -inset-4 rounded-3xl opacity-30 blur-xl" style={{background: 'linear-gradient(135deg, #D4AF5F, #050E1E)'}}></div>
              <div className="relative rounded-3xl overflow-hidden shadow-2xl border-2" style={{borderColor: 'rgba(201,168,76,0.4)'}}>
                ...
                />
                <div className="absolute inset-0" style={{background: 'linear-gradient(to top, rgba(5,14,30,0.75) 0%, transparent 60%)'}}></div>
                <div className="absolute bottom-4 left-4 right-4">
                  <p className="text-white font-semibold text-sm" style={{color: '#E7C98A'}}>✦ Post-Construction Clean — Real Results</p>
                </div>
              </div>
              <div className="absolute -bottom-6 -right-6 bg-white p-5 rounded-2xl shadow-xl border border-gray-100" style={{background: '#071A2F', borderColor: 'rgba(212,175,95,0.6)'}}>
                <div className="flex items-center space-x-3">
                  <div className="p-3 rounded-lg" style={{background: 'rgba(201,168,76,0.2)'}}>
                    <CheckCircle className="w-6 h-6" style={{color: '#D4AF5F'}} />
                  </div>
                  <div>
      ...
      <section className="py-20 border-t" style={{background: '#f8f6f0', borderColor: '#e8d9b0'}}>
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            <span className="font-semibold text-sm uppercase tracking-wide" style={{ color: '#D4AF5F' }}>Proof of Diligence</span>
          ...
          <div className="grid lg:grid-cols-3 gap-8">
            {proofItems.map((item) => (
              <button
                ...
                style={{background: '#fff', borderColor: 'rgba(212,175,95,0.2)'}}
                aria-label={`Open ${item.title} in full screen`}
              >
                <div className="relative">
                  <div className="absolute left-3 top-3 z-10 px-2 py-1 rounded-full text-[10px] font-bold uppercase tracking-wide" style={{background: 'rgba(5,14,30,0.85)', color: '#f8f6f0'}}>
                    Before & After
                  </div>
          ...
          <div className="mt-20">
            <div className="text-center mb-8">
              <span className="font-semibold text-sm uppercase tracking-wide" style={{ color: '#D4AF5F' }}>Crew at work</span>
            ...
            <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-6">
              {crewWork.map((shot) => (
                <button
                  ...
                  style={{borderColor: 'rgba(212,175,95,0.2)', background: '#fff'}}
          ...
          <div className="mt-20">
            <div className="flex flex-col sm:flex-row sm:items-end sm:justify-between gap-4 mb-8">
              <div>
                <p className="text-sm font-semibold uppercase tracking-[0.18em]" style={{ color: '#D4AF5F' }}>Campaigns</p>
            ...
            <div className="grid lg:grid-cols-3 gap-8">
              {promoPosters.map((poster) => (
                <button
                  ...
                  style={{borderColor: 'rgba(212,175,95,0.25)', background: '#fff'}}
                ...
                >
                  ...
                  <div className="absolute inset-x-0 bottom-0 z-20 p-5">
                    <span className="inline-flex items-center rounded-full px-3 py-1 text-[10px] font-bold uppercase tracking-[0.18em]" style={{ background: 'rgba(212,175,95,0.15)', color: '#f5e7aa' }}>
                      {poster.tag}
                    </span>
      ...
      <section className="py-20 border-t" style={{background: '#f8f6f0', borderColor: '#e8d9b0'}}>
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            <span className="font-semibold text-sm uppercase tracking-wide" style={{ color: '#D4AF5F' }}>Cleaning Tips</span>
            <h2 className="text-3xl md:text-5xl font-bold mt-4 mb-4" style={{ color: '#0a0f2e' }}>
          ...
          <div className="grid gap-6 md:grid-cols-2 xl:grid-cols-3">
            {homeTips.map((tip) => (
              <div key={tip.file} className="rounded-3xl overflow-hidden border shadow-lg hover:shadow-xl transition-all" style={{ background: '#fff', borderColor: 'rgba(201,168,76,0.2)' }}>
                ...
                <div className="p-5">
                  <div className="mb-2 text-sm font-bold uppercase tracking-wide" style={{ color: '#D4AF5F' }}>{tip.title}</div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-6">
            {highlights.map((highlight, index) => (
              ...
              >
                <CheckCircle className="w-8 h-8 mb-3" style={{color: '#D4AF5F'}} />
